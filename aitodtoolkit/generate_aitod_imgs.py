...
if __name__ == '__main__':
    ...
    for idx, image_name in enumerate(tqdm(os.listdir(image_path))):
        try:
            ...
            with open('xview/split/error.txt', 'a') as f:
                f.write(image_name + '\n')
    ...
    for label_name in tqdm(os.listdir(origin_label_path)):
